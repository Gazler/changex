defmodule Changex.GrouperTest do
  ...
  test "group_by_type includes breaking changes" do
    commits = [
      ["f329668f8661795f6e2b3c9fd7b7ae6de7dc3789", "fix(baz): set baz", "some stuff", "BREAKING CHANGE: this breaks", "a previous thing", "", "BREAKING CHANGE: another", ""],
      ["6a02160216344cf84f8ec7b13bb10a29f2caa340", "chore(bar): set bar", ""],
      ["d01c9ae1622683b1ca33e281ff71d0f10c234c46", "chore(foo): set foo", "BREAKING CHANGE: this also breaks", "something", ""]
    ]
    expected = %{
      fix: [[hash: "f329668f8661795f6e2b3c9fd7b7ae6de7dc3789", type: :fix, scope: "baz", description: "set baz"]],
      chore: [
      ...
      break: [
        [hash: "f329668f8661795f6e2b3c9fd7b7ae6de7dc3789", type: :break, scope: "baz", description: "this breaks\na previous thing"],
        [hash: "f329668f8661795f6e2b3c9fd7b7ae6de7dc3789", type: :break, scope: "baz", description: "another"],
        [hash: "d01c9ae1622683b1ca33e281ff71d0f10c234c46", type: :break, scope: "foo", description: "this also breaks\nsomething"]
      ]
    }
    assert Changex.Grouper.group_by_type(commits) == expected
  end
